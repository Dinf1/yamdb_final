    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('score', models.PositiveSmallIntegerField(default=1, validators=[django.core.validators.MinValueValidator(1, 'Оценка должна быть больше 1.'), django.core.validators.MaxValueValidator(10, 'Оценка должна быть меньше 10.')], verbose_name='Рейтинг')),
